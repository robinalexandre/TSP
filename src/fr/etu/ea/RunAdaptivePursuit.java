...
public class RunAdaptivePursuit implements Runnable {
	...
	public RunAdaptivePursuit(Integer populationSize, Integer probabilityMutation, Integer probabilityCroisement, int nbSelection, float pmin, float beta, float alpha, int windowSize, ISelection[] selection, ICrossover[] crossover, IMutation[] mutation, IInsertion[] insertion, double[][] distance, long duration) {
		super();
